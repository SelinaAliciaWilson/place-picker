  ...
  _performAutoCompleteSearch(String searchTerm) async {
    ...
    if (searchTerm.isNotEmpty) {
      final PlacesAutocompleteResponse response =
        ...
        types: widget.autocompleteTypes == null ? [] : widget.autocompleteTypes,
        components: widget.autocompleteComponents == null ? [] : widget.autocompleteComponents,
        strictbounds: widget.strictbounds == null ? false : widget.strictbounds,
